    ...
    content: (
      <div className="space-y-4">
        <p className="text-gray-700 leading-relaxed">
          Counseling at the University Counselling Centre is a friendly and supportive space where you can share your thoughts, explore personal concerns, and develop strategies to enhance your well-being. You can attend multiple sessions as per your wish, creating a personalized experience.
        </p>
        ...
        <p className="text-gray-700 text-sm">
          Our experienced counselors are here to listen and guide you, ensuring you feel comfortable and empowered.
        </p>
      </div>
    )
  },
    ...
    content: (
      <div className="space-y-4">
        ...
        <div className="bg-yellow-50 p-4 rounded-lg border border-yellow-200">
          <h4 className="font-semibold text-yellow-800 mb-2">When We May Share:</h4>
...
export default function ConsentForm() {
  ...
  const handleSubmitWithoutTest = () => {
    ...
    const consentData = JSON.parse(localStorage.getItem('consentFormData') || '{}');
      ...
      <div className="max-w-4xl mx-auto">
        <Card className="shadow-2xl border-0 bg-white print:shadow-none">
          <CardContent className="p-0">
            <div className="bg-white p-12 mx-auto print:p-8" style={{ width: '210mm', minHeight: '297mm', boxShadow: '0 0 20px rgba(0,0,0,0.1)', position: 'relative' }}>
              <div className="text-center mb-8 pb-6">
                <div className="inline-flex items-center justify-center w-20 h-20">
                  <img src="./logo.jpeg" alt="Aditya University Logo" className="w-20 h-20 object-contain" />
                </div>
                <h1 className="text-2xl font-bold text-gray-800 mb-2">INFORMED CONSENT</h1>
                <div className="text-sm text-gray-600 space-y-1">
                  <p className="text-2xl font-bold text-blue-800">ADITYA UNIVERSITY, SURAMPALEM</p>
                  <p className="text-lg font-semibold text-gray-700">University Counselling Centre</p>
                  <p className="text-sm">Surampalem, Andhra Pradesh | (123) 456-7890 | counseling@adityauniversity.edu</p>
                  <Badge variant="outline" className="mt-2 border-blue-600 text-blue-600">Confidential</Badge>
                </div>
              </div>
              ...
              <ScrollArea className="h-auto mb-8">
                <div className="space-y-4">
                  {accordionSections.map((section) => (
                    <div key={section.value} className="border border-gray-200 rounded-lg">
                      <h3 className="px-4 py-3 font-semibold text-gray-800 bg-gray-50">{section.title}</h3>
                      <div className="px-4 pb-4 accordion-content">{section.content}</div>
                    </div>
                  ))}
                </div>
              </ScrollArea>
                ...
                <FormProvider {...form}>
                  <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    <div className="text-center mb-6">
                      ...
                      <Badge variant="secondary" className="bg-blue-100 text-blue-800">Please fill in all fields</Badge>
                    </div>
                    ...
                    <div className="space-y-4 p-4 border border-gray-200 rounded-lg bg-gray-50">
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-base font-semibold text-gray-800">Full Name</FormLabel>
                            <FormControl>
                              <Input
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-base font-semibold text-gray-800">Roll Number</FormLabel>
                            <FormControl>
                              <Input
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-base font-semibold text-gray-800">Phone Number</FormLabel>
                            <FormControl>
                              <Input
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-base font-semibold text-gray-800">Counselor Name</FormLabel>
                            <FormControl>
                              <Select onValueChange={field.onChange} value={field.value}>
                                ...
                                <SelectContent>
                                  ...
                                  <SelectItem value="Mr. Anil Kumar">Mr. Anil Kumar</SelectItem>
                                </SelectContent>
                              </Select>
                            </FormControl>
                            <FormMessage />
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="flex flex-col">
                          <FormLabel className="text-base font-semibold text-gray-800">Date</FormLabel>
                          <FormControl>
                            <Input
                              type="date"
                              {...field}
        ...
        {/* Dialog for choosing submission option */}
        <Dialog open={optionDialog} onOpenChange={setOptionDialog}>
          <DialogContent className="sm:max-w-[425px]">
            <DialogTitle>Choose Your Next Step</DialogTitle>
            <DialogDescription>
              Please select how you would like to proceed after submitting the consent form.
            </DialogDescription>
